...
function eliminarVenta(idVenta) {
    // Aquí podrías implementar la lógica para eliminar la venta con el id proporcionado
    console.log('Eliminar venta con id:', idVenta);
}

// Función para descargar
function Download() {
    // Aquí podrías implementar la lógica para descargar algún contenido relacionado con la venta
