    ...
    function renderServicios(servicios) {
        ...
        servicios.forEach(servicio => {
            ...
            tr.innerHTML = `
                ...
                <td>${estado}</td>
                <td>
                    <a class="Btn-shadow" onclick="verDetalle(${servicio.idServicio})" style="margin-left: 15px; margin-bottom: 15px; float: inline-start;">
                    ...
                    <a class="Btn-delete8" onclick="eliminarServicio(${servicio.idServicio})" style="margin-left: 15px; margin-bottom: 15px; float: inline-start;">
                    ...
                    <a class="Btn-update" onclick="ModificarServicio(${servicio.idServicio})" style="margin-left: 15px; margin-bottom: 15px; float: inline-start;">
...
function verDetalle(idServicio) {
    window.location.href = `/ServiciosShadow?id=${idServicio}`;
}

function ModificarServicio(idServicio) {
    window.location.href = `/ServiciosUpdate?id=${idServicio}`;
}

// Función para eliminar el servicio con el ID específico
function eliminarServicio(idServicio) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios.delete(`http://localhost:5235/api/Servicio/${idServicio}`)
                .then(response => {
