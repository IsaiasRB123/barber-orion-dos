    ...
    function renderServicios(servicios) {
        ...
        servicios.forEach(servicio => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <a class="Btn-shadow" href="/ServiciosShadow" style="margin-left: 15px; margin-bottom: 15px; float: inline-start;">
                    ...
                    <a class="Btn-delete8" onclick="Eliminar()" style="margin-left: 15px; margin-bottom: 15px; float: inline-start;">
