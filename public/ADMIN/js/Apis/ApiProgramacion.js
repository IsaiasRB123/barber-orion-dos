 ...
 function eliminarEmpleado(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`http://isaiasrb-001-site1.ctempurl.com/api/programempleado/${id}`)
          .then(response => {
            Swal.fire({
              title: '¡Eliminado!',
  ...
  function renderEmpleados(empleados) {
    ...
    empleados.forEach(empleado => {
      ...
      tr.innerHTML = `
        ...
        <td>
          <a class="Btn-shadow" href="/ProgramarVis?id=${empleado.id}" style="margin-left: 15px; margin-bottom: 15px; float: inline-start;">
          ...
          <a class="Btn-update" href="/ProgramarAct?id=${empleado.id}" style="margin-left: 15px; margin-bottom: 15px; float: inline-start;">
...
axios.get(`http://isaiasrb-001-site1.ctempurl.com/api/programempleado/${id}`)
  .then(response => {
