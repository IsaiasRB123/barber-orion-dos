document.addEventListener('DOMContentLoaded', function () {
    // URL de la API
    const apiUrl = 'http://localhost:5087/api/Usuario';
    ...
    function renderServicios(servicio) {
        ...
        servicios.forEach(servicio => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <a class="Btn-shadow" href="/UsuariosVer/${servicio.idServicio`" style="margin-left: 15px; margin-bottom: 15px; float: inline-start;">
                    ...
                    <a class="Btn-update" href="/UsuariosModificar" style="margin-left: 15px; margin-bottom: 15px; float: inline-start;">
